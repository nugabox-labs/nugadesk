// Generated from the local FontAwesome Pro 7 CSS (see public/fontawesome/css/fontawesome.min.css).
// Icon names only (no "fa-" prefix) — pair with FaIcon, e.g. <FaIcon name="house" />.
export const FA_ICON_NAMES: readonly string[] = [
  "00",
  "100",
  "11ty",
  "360-degrees",
